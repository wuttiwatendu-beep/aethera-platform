...
# CSS สำหรับตกแต่ง Card ให้สวยและสว่าง
st.markdown("""
    <style>
...
st.markdown("<p style='text-align: center;'>ระบบบริหารจัดการพลังงานอัจฉริยะ มทร.อีสาน (Smart Grid Phase 1)</p>", unsafe_allow_html=True)

# --- ส่วนที่ 1: Environment Benefits (ดึงรูปที่คุณนุต้องการ ผ่าน Link ที่เสถียรที่สุด) ---
...
with c1:
    ...
    # ใช้รูปเมฆ CO2 ที่คุณนุส่งมา
    st.image("https://i.ibb.co/L9YmYfG/co2-cloud.png", width=150)
...
with c2:
    ...
    # ใช้รูปถ่านหินที่คุณนุส่งมา
    st.image("https://i.ibb.co/FmP0S58/coal-hand.png", width=150)
...
with c3:
    ...
    # ใช้รูปต้นไม้ที่คุณนุส่งมา
    st.image("https://i.ibb.co/DfqV8Y8/green-trees.png", width=150)
