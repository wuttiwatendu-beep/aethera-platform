...
with col_l:
    ...
    fig_24h.update_layout(height=500, margin=dict(l=0,r=0,t=10,b=0))
    st.plotly_chart(fig_24h, use_container_width=True)

with col_r:
    st.markdown("<div class='section-header'>📊 Station Details (9+1 Stations)</div>", unsafe_allow_html=True)
    # รวมข้อมูลเดิม 7 แห่ง + 2 แห่งใหม่ที่ศูนย์กลาง + 1 แห่งที่หนองระเวียง
    df_stations = pd.DataFrame([
        ...
        {"อาคาร": "อาคาร A (สำรอง)", "kW": 150.00, "Zone": "ศูนย์กลาง"}, # เพิ่มใหม่ 1
        {"อาคาร": "อาคาร B (สำรอง)", "kW": 150.00, "Zone": "ศูนย์กลาง"}, # เพิ่มใหม่ 2
