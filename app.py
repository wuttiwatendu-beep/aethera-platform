...
with e1:
    ...
    st.markdown("<div class='esg-number'>27.24 T</div><div style='font-weight:600;'>CO2 Saved</div>", unsafe_allow_html=True)
    st.markdown("</div>", unsafe_allow_html=True)
with e2:
    st.markdown("<div class='esg-box'>", unsafe_allow_html=True)
    st.image("Coal.png", width=110) #
    st.markdown("<div class='esg-number'>21.79 T</div><div style='font-weight:600;'>Coal Saved</div>", unsafe_allow_html=True)
    st.markdown("</div>", unsafe_allow_html=True)
with e3:
    st.markdown("<div class='esg-box'>", unsafe_allow_html=True)
    st.image("Tree.png", width=110)
    st.markdown("<div class='esg-number'>680 Trees</div><div style='font-weight:600;'>Planted</div>", unsafe_allow_html=True)
    st.markdown("</div>", unsafe_allow_html=True)
...
with col_r:
    ...
    fig_mix.update_layout(height=280, margin=dict(l=0,r=0,t=0,b=0))
