...
# CSS ตกแต่ง Card ให้สวยและสว่าง
st.markdown("""
    <style>
    ...
    .env-value { font-size: 1.5rem; font-weight: bold; color: #E85D04; margin-top: 10px; }
    </style>
...
st.markdown("<p style='text-align: center; color: #64748b;'>ระบบบริหารจัดการพลังงานอัจฉริยะ (Smart Grid) มทร.อีสาน</p>", unsafe_allow_html=True)
...
# ใส่รูปภาพโดยใช้ URL มาตรฐานที่เสถียรที่สุด (ไอคอนใกล้เคียงกับที่คุณนุส่งมา)
with c1:
    st.markdown("<div class='env-card'><div class='env-title'>CO2 Emission Saved</div>", unsafe_allow_html=True)
    st.image("https://cdn-icons-png.flaticon.com/512/1843/1843544.png", width=100)
